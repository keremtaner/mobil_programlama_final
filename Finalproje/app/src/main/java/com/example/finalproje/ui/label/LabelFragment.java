package com.example.finalproje.ui.label;
...
import com.example.finalproje.databinding.FragmentLabelBinding;
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()){
                   for (QueryDocumentSnapshot document : task.getResult()){
                    ...
                    Log.d("TAG","DOSYA ALINIRKEN HATA OLDU", task.getException());
                }
            }
        });
                            ...
                            labelref.add(new Label(labelEditText))
                                    ...
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(getActivity(),"label ekleme basarısız",Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        }
                    }
